            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  ...
                  <a href="category_dashboard.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-lock fa-fw me-3"></i><span>Catagory dashboard</span></a>
                      </a>
...
<table class="table container table-bordered table-dark">
  ...
  <tbody class="table-light">
    ...
    $stmt = $conn->query("SELECT * FROM user_admin");
    ...
    while($admin = $stmt->fetch_assoc())
    {
      if($admin['is_deleted']== 0)
      {
        ...
        echo '<a href="admin_update.php?id='. $admin['id'] .'"<button  class="btn  btn-sm"><i class="fa-solid fa-pen-to-square"></i>Update</button></a>';
        echo '<a href="admin_delete.php?id='. $admin['id'] .'"<button  class="btn  btn-sm"><i class="fa-solid fa-trash-can"></i>delete</button></a>';
